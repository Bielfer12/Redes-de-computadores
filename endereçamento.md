# Plano de Endereçamento IP e VLSM
**Projeto:** Redes de Computadores - Interligação de 3 Sites em Anel Roteado

## Arquitetura de Redes (VLANs e Segurança)
...
## 4. Links WAN (Anel Roteado)
Bloco principal: `192.168.100.0/24`
*Nota: Máscara /30 utilizada para otimizar os endereçamentos ponto a ponto e prevenir desperdício.*

| Conexão (Interface Router) | Rede | Máscara | IPs Úteis |
| :--- | :--- | :--- | :--- |
| **Matriz <-> Filial 1** | `192.168.100.0` | `/30` (255.255.255.252) | `192.168.100.1` (Matriz) / `192.168.100.2` (Filial 1) |
| **Filial 1 <-> Filial 2** | `192.168.100.4` | `/30` (255.255.255.252) | `192.168.100.5` (Filial 1) / `192.168.100.6` (Filial 2) |
| **Filial 2 <-> Matriz** | `192.168.100.8` | `/30` (255.255.255.252) | `192.168.100.9` (Filial 2) / `192.168.100.10` (Matriz) |